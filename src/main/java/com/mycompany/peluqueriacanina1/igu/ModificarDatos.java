...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tituloLabel.setText("Modificar Datos");
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        ...
        control.modificarMascota(masco,nombre,area,celDuenio,color,NombreDuenio,raza,alergico,especial);
        
        //escribir mensaje de que todo salio ok
        mostrarMensaje("edicion realizada correctamente","INFO","edicion correcta");
        
        //abrir pantalla VerDatos
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtArea.setText(masco.getObservaciones());
